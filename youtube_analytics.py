...
def sync_all_channels():
    ...
    channels = {
                "lofi_barista": {"youtube_id": "UCC76tzAG4JH8YYtehJAhwCg", "name": "Lofi Barista"},
                "rain_walker": {"youtube_id": "UCTS92ipxcFAe3DIL4BYmycQ", "name": "Rain Walker"},
                "velvet_groove": {"youtube_id": "UCqDKZ3d6A3baCnmVp5JahJw", "name": "Velvet Groove"},
                "piano_ghost": {"youtube_id": "UCEbUj2bHA6kzm_GKrEB-YTw", "name": "Piano Ghost"},
    }
