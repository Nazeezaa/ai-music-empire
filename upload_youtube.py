...
def build_metadata(config, genre=None, mood=None):
    ...
    yt = config["youtube"]
    genre = genre or config["suno"]["default_genre"]
    mood = mood or config["suno"]["default_mood"]
    ...
    return {
        "snippet": {"title": title[:100], "description": description[:5000],
                     "tags": content["tags"], "categoryId": str(yt["category_id"]),
                     "defaultLanguage": yt.get("default_language", "en")},
